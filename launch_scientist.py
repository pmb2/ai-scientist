...
from ai_scientist.llm import create_client, _is_openrouter_model, AVAILABLE_LLMS
...
def _aider_model_name(model):
    """Map AI Scientist model name to Aider's Model() name format."""
...
def do_idea(
    ...
    try:
        ...
        main_model = Model(_aider_model_name(model))
        coder = Coder.create(
